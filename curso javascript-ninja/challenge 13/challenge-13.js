...
brasil.unshift ('Amazonas', 'Pará', 'Macapá');
...
*/
console.log( '\nTodos os estados de `brasil` tem mais de 7 letras?', todosTemMaisDe7Letras );
...
var map = newBrasil.map(function(item) {
  return {
    id: item.id + 1,  // Somando 1 ao ID
    estado: `${item.estado} pertence ao Brasil.`  // Adicionando a frase no estado
  };
});
