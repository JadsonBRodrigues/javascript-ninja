...
(function () {
	...
	*/
	...
	var testClass = new RegExp (/class=[\"\']([\w\s]+)[\"\']/g);


	var hasClass = function hasClass (markup, cssClass) {


	function hasClass (markup, cssClass) {

		markup.match(cssClass) ? console.log (`true para a classe ${cssClass}`) 
		: console.log (`false para a classe ${cssClass}`);
	};
